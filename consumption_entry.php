...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="include/js/consumption.js"></script>
    </head>	
<body>
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-active" role="tabpanel" aria-labelledby="pills-active-tab" tabindex="0">
                                                    <?php 
                                                        $cancelled = 0;
                                                        $id = "table-active";
                                                        include("consumption_entry_table.php"); 
                                                    ?>
                                                </div>
        ...
        if (!jQuery.fn.DataTable.isDataTable('#' + tableId)) {
            jQuery('#' + tableId).DataTable({
                ...
                "columns": [
                    ...
                    { "data": "consumption_entry_date", "className": "text-center" },
