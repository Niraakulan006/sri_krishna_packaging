                                            ...
                                            <div class="row justify-content-end p-2">
                                                <div class="col-lg-4 col-md-4 col-6">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" style="height:34px;" name="search_text" placeholder="Search By Godown Name/Location" aria-label="Search" aria-describedby="basic-addon2"  onkeyup="Javascript:table_listing_records_filter();">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-4">
                                                    <?php
                                                        if(empty($add_access_error) && $godown_count < $GLOBALS['max_godown_count']) { 
                                                            ?>
