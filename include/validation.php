		...
		public function valid_percentage($field_value, $field_name, $required) {
			...
			if(!empty($field_value)) {
				...
				if(empty($result)) {
					...
					if (!preg_match("/^[0-9]+(\.[0-9]{1,2})?$/", $field_value)) {
						$result = "Invalid ".$field_name;
					}
				}
			}
			...
			if(!empty($error)) {
				...
				if($type == "custom_radio") {
					$result = "if(jQuery('form[name=".'"'.$form_name.'"'."] input[name=".'"'.$field.'"'."]').parent().parent().parent().parent().parent().find('span.infos').length == 0) {
									jQuery('form[name=".'"'.$form_name.'"'."] input[name=".'"'.$field.'"'."]').parent().parent().parent().parent().after('<span class=".'"infos text-danger"'."> <i class=".'"fa fa-exclamation-circle"'."></i>".$error."</span>');
								}";
				}
				...
				if($type == "on_off_checkbox") {
					$result = "if(jQuery('form[name=".'"'.$form_name.'"'."] checkbox[name=".'"'.$field.'"'."]').parent().parent().parent().find('span.infos').length == 0) {
									jQuery('form[name=".'"'.$form_name.'"'."] checkbox[name=".'"'.$field.'"'."]').parent().parent().after('<span class=".'"infos text-danger"'."> <i class=".'"fa fa-exclamation-circle"'."></i>".$error."</span>');
								}";
				}
			}
