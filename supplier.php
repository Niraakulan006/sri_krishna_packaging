                                            ...
                                            <div class="row justify-content-end p-2">
                                                <div class="col-lg-4 col-md-4 col-6">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" style="height:34px;" name="search_text" placeholder="Search By Name/Mbl No/Location" aria-label="Search" aria-describedby="basic-addon2"  onkeyup="Javascript:table_listing_records_filter();">
