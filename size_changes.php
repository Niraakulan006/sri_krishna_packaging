                            ...
                            <div class="dropdown">
                                ...
                                <?php if(empty($edit_access_error)) { 
                                    ...
                                    if(empty($delete_access_error)) {
                                        $linked_count = 0;
                                        // $linked_count = $obj->GetLinkedCount($list['size_id'], $GLOBALS['inward_material_table'], 'size_id');
    ...
    if(isset($_REQUEST['delete_size_id'])) {
        ...
        if(!empty($delete_size_id)) {
            ...
            if(preg_match("/^\d+$/", $size_unique_id)) {
                ...
                $linked_count = 0;
                // $linked_count = $obj->GetsizeLinkedCount($delete_size_id);
                // if(empty($linked_count)) {
                    $columns = array();
                    $values = array();
                ...
                // }
                // else {
                //     $msg = "This size is associated with other screens";
                // }
            }
        }
        echo $msg;
