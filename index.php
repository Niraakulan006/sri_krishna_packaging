<?php 
    ...
    if(isset($_POST['name'])) {	
		...
		$valid_user = ""; $form_name = "login_form";
		...
		if(empty($valid_user) && $users_count == 0) {
            ...
            $created_date_time = $GLOBALS['create_date_time_label']; $creator = $GLOBALS['creator']; $creator_name = $name;
            ...
            $columns = array('created_date_time', 'creator', 'creator_name', 'user_id', 'role_id', 'name', 'mobile_number', 'name_mobile', 'login_id', 'lower_case_login_id', 'password', 'admin', 'type', 'godown_id', 'deleted');
            $values = array("'".$created_date_time."'", "'".$creator."'", "'".$creator_name."'", "'".$null_value."'", "'".$null_value."'", "'".$name."'", "'".$mobile_number."'", "'".$name_mobile."'", "'".$login_id."'", "'".$lower_case_login_id."'", "'".$password."'", "'".$admin."'", "'".$type."'", "'".$null_value."'", "'0'");
...
<head>
    <meta charset="utf-8">
    <title>Dashboard | Sri Krishna Packaging </title>
    ...
    <script src="include/js/creation_module.js"></script>
                ...
                <div class="col-lg-12">
                    <div class="text-center mt-sm-4 text-white-50">
                        <a href="index.php" class="d-inline-block auth-logo">
                           <img src="images/plogo.png" class="img-fluid w-25" alt="Sri Krishna Packaging " title="Sri Krishna Packaging ">
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card mt-4">
                            <div class="card-body p-3">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign <?php if(!empty($users_count)) { ?>in<?php } else { ?>up<?php } ?> to continue to Sri Krishna Packaging .</p>
                                </div>
                                <form name="login_form" method="post" action="index.php" class="redirection_form">
                                    <div class="row p-2 mt-4">
                                        <?php if(!empty($users_count)) { ?>
                                            ...
                                            <div class="text-center">
                                                <button class="btn btn-danger w-25 submit_button" type="button" onClick="Javascript:SaveModalContent('login_form', 'index.php', 'dashboard.php');">Log In</button>
                                            </div>
                                            <?php } else { ?>
                                                <div class="row">
                                                ...
                                                <div class="text-center">
                                                    <button class="btn btn-danger w-25 submit_button" type="button" onClick="Javascript:SaveModalContent('login_form', 'index.php', 'index.php');">Submit</button>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
