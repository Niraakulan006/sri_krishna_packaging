<?php
	...
	if(isset($_REQUEST['show_inward_material_id'])) { 
        ...
        ?>
        <form class="poppins pd-20" name="inward_material_form" method="POST">
			<div class="card-header">
				<div class="row p-2">
					<div class="col-lg-8 col-md-8 col-8 align-self-center">
                        <?php if(!empty($show_inward_material_id)) { ?>
                            <div class="h5">Edit Inward Material</div>
                        <?php } else { ?>
            ...
            <div class="row px-3 py-1">
                <input type="hidden" name="edit_id" value="<?php if(!empty($show_inward_material_id)) { echo $show_inward_material_id; } ?>">
                ...
                <div class="col-lg-2 col-md-3 col-6 py-2 px-lg-1">
                    <div class="form-group">
                        <div class="form-label-group in-border">
                            <input type="text" id="bill_number" name="bill_number" class="form-control shadow-none" onkeydown="Javascript:KeyboardControls(this,'',30,1);" placeholder="" value="<?php if(!empty($bill_number)) { echo $bill_number; } ?>">
                    ...
                    <div class="form-group">
                        <div class="form-label-group in-border chargesaction">
                            <div class="input-group">
                                <select name="supplier_id" class="select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    ...
                                    <?php
                                        if(!empty($supplier_list)) {
                                            foreach($supplier_list as $data) {
                                                if(!empty($data['supplier_id']) && $data['supplier_id'] != $GLOBALS['null_value']) {
                                                    ?>
                                                    <option value="<?php echo $data['supplier_id']; ?>" <?php if((!empty($supplier_id) && $supplier_id == $data['supplier_id']) || $supplier_count == '1') { ?>selected<?php } ?>>
                                                        <?php
                ...
                <div class="col-lg-3 col-md-4 col-12 px-lg-1 py-2">
                    ...
                    <div class="form-group <?php if($location_type != '2') { ?>d-none<?php } ?>" id="selected_factory_id_div">
                        <div class="form-label-group in-border" <?php if($location_type == '2') { ?>style="pointer-events:none;"<?php } ?>>
                            <select name="selected_factory_id" class="select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" <?php if($location_type == '2') { ?>tabindex="1"<?php } ?> onchange="Javascript:GetCurrentStock('inward_material');">
                ...
                <div class="col-lg-2 col-md-4 col-12 px-lg-1 py-2">
                    <div class="form-group">
                        <div class="form-label-group in-border chargesaction" id="selected_size_id_div">
                            <div class="input-group" id="selected_size_id_group">
                                <select name="selected_size_id" class="select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" onchange="Javascript:GetCurrentStock('inward_material');">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text bg-primary" style="cursor:pointer; height:100%;" onclick="Javascript:CustomButton('size');"><i class="fa fa-plus text-white"></i></span>
                                </div>
                            </div>
                            <div class="input-group d-none" id="selected_size_name_group">
                                <input type="text" name="selected_size_name" id="selected_size_name" class="form-control shadow-none" onkeydown="Javascript:KeyboardControls(this,'number',15,'');" onkeyup="Javascript:InputBoxColor(this,'text');" placeholder="">
                                <label>Size <span class="text-danger">*</span></label>
                                <div class="input-group-append">
                                    <span class="input-group-text bg-danger" style="cursor:pointer; height:100%;" onclick="Javascript:ClearCustomButton('size');"><i class="fa fa-times text-white"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-2 col-md-4 col-12 px-lg-1 py-2">
                    <div class="form-group">
                        <div class="form-label-group in-border chargesaction" id="selected_gsm_id_div">
                            <div class="input-group" id="selected_gsm_id_group">
                                <select name="selected_gsm_id" class="select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" onchange="Javascript:GetCurrentStock('inward_material');">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text bg-primary" style="cursor:pointer; height:100%;" onclick="Javascript:CustomButton('gsm');"><i class="fa fa-plus text-white"></i></span>
                                </div>
                            </div>
                            <div class="input-group d-none" id="selected_gsm_name_group">
                                <input type="text" name="selected_gsm_name" id="selected_gsm_name" class="form-control shadow-none" onkeydown="Javascript:KeyboardControls(this,'number',3,'');" onkeyup="Javascript:InputBoxColor(this,'text');" placeholder="">
                                <label class="text-center">GSM <span class="text-danger">*</span></label>
                                <div class="input-group-append">
                                    <span class="input-group-text bg-danger" style="cursor:pointer; height:100%;" onclick="Javascript:ClearCustomButton('gsm');"><i class="fa fa-times text-white"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-2 col-md-4 col-12 px-lg-1 py-2">
                    <div class="form-group">
                        <div class="form-label-group in-border chargesaction" id="selected_bf_id_div">
                            <div class="input-group" id="selected_bf_id_group">
                                <select name="selected_bf_id" class="select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" onchange="Javascript:GetCurrentStock('inward_material');">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text bg-primary" style="cursor:pointer; height:100%;" onclick="Javascript:CustomButton('bf');"><i class="fa fa-plus text-white"></i></span>
                                </div>
                            </div>
                            <div class="input-group d-none" id="selected_bf_name_group">
                                <input type="text" name="selected_bf_name" id="selected_bf_name" class="form-control shadow-none" onkeydown="Javascript:KeyboardControls(this,'number',15,'');" onkeyup="Javascript:InputBoxColor(this,'text');" placeholder="">
                                <label>BF <span class="text-danger">*</span></label>
                                <div class="input-group-append">
                                    <span class="input-group-text bg-danger" style="cursor:pointer; height:100%;" onclick="Javascript:ClearCustomButton('bf');"><i class="fa fa-times text-white"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">    
                <div class="col-lg-12 text-center">
                    ...
                    <div class="table-responsive text-center tableheight">
                        ...
                        <table class="table table-nowrap nowrap cursor smallfnt w-100 table-bordered product_table">
                            ...
                            <tbody>
                                <?php 
                                    if(empty($show_inward_material_id)) { 
                                        ?>
                ...
                <div class="col-md-12 py-3 text-center">
                    <button class="btn btn-primary" type="button" onclick="Javascript:SaveModalContent('inward_material_form', 'inward_material_changes.php', 'inward_material.php');"> Submit </button>
                </div>
            </div>
    ...
    if(isset($_POST['edit_id'])) {
        $bill_date = ""; $bill_date_error = ""; $bill_number = ""; $bill_number_error = ""; $supplier_id = ""; $supplier_id_error = "";
        ...
        if(isset($_POST['bill_date'])) {
            ...
            if(!empty($bill_date_error)) {
                if(!empty($valid_inward_material)) {
                    $valid_inward_material = $valid_inward_material." ".$valid->error_display($form_name, 'bill_date', $bill_date_error, 'text');
                }
                else {
                    $valid_inward_material = $valid->error_display($form_name, 'bill_date', $bill_date_error, 'text');
                }
            }
        }
        if(isset($_POST['bill_number'])) {
            $bill_number = trim($_POST['bill_number']);
            $bill_number_error = $valid->common_validation($bill_number, 'Bill Number', 'text');
            if(!empty($bill_number_error)) {
                if(!empty($valid_inward_material)) {
                    $valid_inward_material = $valid_inward_material." ".$valid->error_display($form_name, 'bill_number', $bill_number_error, 'text');
                }
                else {
                    $valid_inward_material = $valid->error_display($form_name, 'bill_number', $bill_number_error, 'text');
                }
            }
        }
        if(isset($_POST['supplier_id'])) {
            ...
            if(!empty($supplier_id_error)) {
                if(!empty($valid_inward_material)) {
                    $valid_inward_material = $valid_inward_material." ".$valid->error_display($form_name, 'supplier_id', $supplier_id_error, 'select');
                }
                else {
                    $valid_inward_material = $valid->error_display($form_name, 'supplier_id', $supplier_id_error, 'select');
                }
            }
        }
        if(isset($_POST['location_type'])) {
            ...
            if(!empty($location_type_error)) {
                if(!empty($valid_inward_material)) {
                    $valid_inward_material = $valid_inward_material." ".$valid->error_display($form_name, 'location_type', $location_type_error, 'select');
                }
                else {
                    $valid_inward_material = $valid->error_display($form_name, 'location_type', $location_type_error, 'select');
                }
            }
        }
        if($location_type == '1') {
            if(isset($_POST['godown_type'])) {
                ...
                if(!empty($godown_type_error)) {
                    if(!empty($valid_inward_material)) {
                        $valid_inward_material = $valid_inward_material." ".$valid->error_display($form_name, 'godown_type', $godown_type_error, 'select');
                    }
                    else {
                        $valid_inward_material = $valid->error_display($form_name, 'godown_type', $godown_type_error, 'select');
                    }
                }
            }
        }
        ...
        if(!empty($size_ids)) {
            for($i=0; $i < count($size_ids); $i++) {
                if($location_type == '1') {
                    if(isset($godown_ids[$i])) {
                        ...
                        if(!empty($godown_id_error)) {
                            if(!empty($valid_inward_material)) {
                                $valid_inward_material = $valid_inward_material." ".$valid->row_error_display($form_name, 'godown_id[]', $godown_id_error, 'select', 'product_row', ($i+1));
                            }
                            else {
                                $valid_inward_material = $valid->row_error_display($form_name, 'godown_id[]', $godown_id_error, 'select', 'product_row', ($i+1));
                            }
                        }
                    }
                }
                    ...
                    if(isset($factory_ids[$i])) {
                        ...
                        if(!empty($factory_id_error)) {
                            if(!empty($valid_inward_material)) {
                                $valid_inward_material = $valid_inward_material." ".$valid->row_error_display($form_name, 'factory_id[]', $factory_id_error, 'select', 'product_row', ($i+1));
                            }
                            else {
                                $valid_inward_material = $valid->row_error_display($form_name, 'factory_id[]', $factory_id_error, 'select', 'product_row', ($i+1));
                            }
                        }
                    }
                }
                if(isset($size_ids[$i])) {
                    ...
                    if(!empty($size_id_error)) {
                        if(!empty($valid_inward_material)) {
                            $valid_inward_material = $valid_inward_material." ".$valid->row_error_display($form_name, 'size_id[]', $size_id_error, 'select', 'product_row', ($i+1));
                        }
                        else {
                            $valid_inward_material = $valid->row_error_display($form_name, 'size_id[]', $size_id_error, 'select', 'product_row', ($i+1));
                        }
                    }
                }
                if(isset($gsm_ids[$i])) {
                    ...
                    if(!empty($gsm_id_error)) {
                        if(!empty($valid_inward_material)) {
                            $valid_inward_material = $valid_inward_material." ".$valid->row_error_display($form_name, 'gsm_id[]', $gsm_id_error, 'select', 'product_row', ($i+1));
                        }
                        else {
                            $valid_inward_material = $valid->row_error_display($form_name, 'gsm_id[]', $gsm_id_error, 'select', 'product_row', ($i+1));
                        }
                    }
                }
                if(isset($bf_ids[$i])) {
                    ...
                    if(!empty($bf_id_error)) {
                        if(!empty($valid_inward_material)) {
                            $valid_inward_material = $valid_inward_material." ".$valid->row_error_display($form_name, 'bf_id[]', $bf_id_error, 'select', 'product_row', ($i+1));
                        }
                        else {
                            $valid_inward_material = $valid->row_error_display($form_name, 'bf_id[]', $bf_id_error, 'select', 'product_row', ($i+1));
                        }
                    }
                }
                if(isset($quantity[$i])) {
                ...
                if(empty($valid_inward_material)) {
                    for($j=$i+1; $j < count($size_ids); $j++) {
                        ...
                        if(!empty($combination_error_1)) {
                            if(!empty($valid_inward_material)) {
                                $valid_inward_material = $valid_inward_material." ".$valid->row_error_display($form_name, 'size_id[]', $combination_error_1, 'select', 'product_row', ($i+1));
                            }
                            else {
                                $valid_inward_material = $valid->row_error_display($form_name, 'size_id[]', $combination_error_1, 'select', 'product_row', ($i+1));
                            }
                        }
                        if(!empty($combination_error_2)) {
                            if(!empty($valid_inward_material)) {
                                $valid_inward_material = $valid_inward_material." ".$valid->row_error_display($form_name, 'size_id[]', $combination_error_2, 'select', 'product_row', ($j+1));
                            }
                            else {
            ...
            $inward_material_error = "Add Materials";
        }
        $result = "";
        if(empty($valid_inward_material) && empty($inward_material_error)) {
            ...
            if(preg_match("/^\d+$/", $check_user_id_ip_address)) { 
                ...
                if(!empty($bill_number)) {
                    $bill_number = $obj->encode_decode('encrypt', $bill_number);
                }
                else {
            ...
            if(!empty($valid_inward_material)) {
                $result = array('number' => '3', 'msg' => $valid_inward_material);
            }
            else if(!empty($inward_material_error)) {
                $result = array('number' => '2', 'msg' => $inward_material_error);
            }
        }
    ...
    if(isset($_POST['draw'])){
        ...
        $searchValue = ""; $filter_from_date = ""; $filter_to_date = ""; $filter_supplier_id = ""; $cancelled = 0;
        ...
        if(isset($_POST['filter_supplier_id'])) {
            $filter_supplier_id = trim($_POST['filter_supplier_id']);
        }
        ...
        foreach ($InwardMaterialList as $val) {
            $bill_date = ""; $bill_number = ""; $supplier_name = ""; $total_quantity = 0;
            ...
            if(!empty($val['bill_number']) && $val['bill_number'] != $GLOBALS['null_value']) {
                $bill_number = $obj->encode_decode('decrypt', $val['bill_number']);
            }
            if(!empty($val['supplier_name']) && $val['supplier_name'] != $GLOBALS['null_value']){
                $supplier_name = $obj->encode_decode('decrypt', $val['supplier_name']);
            }
            ...
            if(file_exists("images/pupil.gif")) {
                $material_view = '<a href="Javascript:ViewBillContent('.'\''.$GLOBALS['inward_material_table'].'\''.', '.'\''.$val['inward_material_id'].'\''.');"><img src="images/pupil.gif" alt="View" style="width:30px; height:30px;"></a>';
            }
            else {
    ...
    if(isset($_REQUEST['delete_inward_material_id'])) {
        $delete_inward_material_id = trim($_REQUEST['delete_inward_material_id']);
        $msg = "";
        if(!empty($delete_inward_material_id)) {	
            $inward_material_unique_id = "";
            $inward_material_unique_id = $obj->getTableColumnValue($GLOBALS['inward_material_table'], 'inward_material_id', $delete_inward_material_id, 'id');
        
            if(preg_match("/^\d+$/", $inward_material_unique_id)) {
                $bill_number = "";
                $bill_number = $obj->getTableColumnValue($GLOBALS['inward_material_table'], 'inward_material_id', $delete_inward_material_id, 'bill_number');
    ...
    if(isset($_REQUEST['product_row_index'])) {
        ...
        <tr class="product_row py-2" id="product_row<?php if(!empty($product_row_index)) { echo $product_row_index; } ?>">
            ...
            <th class="delete_element text-center px-2 py-2">
                <a class="pe-2" onclick="Javascript:DeleteProductRow('product_row', '<?php if(!empty($product_row_index)) { echo $product_row_index; } ?>');" style="cursor:pointer;"><i class="fa fa-trash text-danger"></i></a>
            </th>
